...
export const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    ...
    dark:bg-gray-900/70'>
      ...
      <div className={`text-gray-700 dark:text-white sm:text-sm ${!sideBarOpen ? 'max-sm:w-0 oveflow-hidden'
      ...
      max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
        ...
        <img src={assets.close_icon} alt="" className='w-5 absolute
        right-4 top-4 sm:hidden cursor-pointer' onClick={() => setSideBarOpen(false)} />
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        <img src={theme === 'dark' ? assets.menu_icon_dark : assets.menu_icon}
          alt="" onClick={() => setSideBarOpen(true)} className='w-8 sm:hidden cursor-pointer' />
